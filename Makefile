...
lib/lib.a: lib/file.o lib/smprintf.o lib/strsplit.o lib/tun.o lib/unsocket.o lib/json.o lib/seccomp.o
	$(AR) r $@ lib/file.o lib/smprintf.o lib/strsplit.o lib/tun.o lib/unsocket.o lib/json.o lib/seccomp.o
